...
export const srcSetFor = (plate) => plate.widths
  .map((width) => `/pages/opus-max-mac/assets/plates/${plate.slug}-${width}.webp ${width}w`)
  .join(', ');

/** The widest derivative — the `src` fallback. */
export const sourceFor = (plate) =>
  `/pages/opus-max-mac/assets/plates/${plate.slug}-${plate.widths[plate.widths.length - 1]}.webp`;
